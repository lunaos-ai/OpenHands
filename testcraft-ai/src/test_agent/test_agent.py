...
class TestAgent(CodeActAgent):
    VERSION = '2.2'
    """
    TestCraft AI is a specialized agent for automated test generation.
    It analyzes codebases and generates comprehensive test suites with high coverage.
    """
