...
class SecurityAgent(CodeActAgent):
    VERSION = '2.2'
    """
    The Security Agent is a specialized CodeActAgent focused on DevSecOps tasks.
    It continuously scans for vulnerabilities, proposes security fixes, and ensures compliance.
    """
    ...
    def __init__(self, config: AgentConfig, llm_registry: LLMRegistry) -> None:
        """Initializes a new instance of the SecurityAgent class."""
